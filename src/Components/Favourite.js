                    ...
                    <div className="main">
                        <div className="row">
                            ...
                            <ul class="list-group favourites-genres">
                                {
                                    this.state.genres.map((genre)=>(
                                        ...
                                        <li class="list-group-item" style={{background:'#F5C518',color:'black',fontWeight:'bold'}} >{genre}</li> :
                                        <li class="list-group-item" style={{background:'black',color:'#F5C518',cursor:'pointer'}} onClick={()=>this.handleGenreChange(genre)}>{genre}</li>
                                    ))
                                }
                            </ul>
                            </div>
                            <div className="col-lg-9 favourites-table col-sm-12">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr  style={{background:'black',color:'#F5C518'}}>
                                    ...
                                    <tbody>
                                        {
                                            filterarr.map((movieObj)=>(
                                                <tr style={{background:'black',color:'white'}}>
                                                    ...
                                                    <td><button style={{background:'#F5C518',color:'black'}} type="button" class="btn btn-danger" onClick={()=>this.handleDelete(movieObj.id)}>Delete</button></td>
                                                </tr>
                                            ))
                                        }
                                    </tbody>
                                ...
                                <nav aria-label="Page navigation example" style={{background:'#F5C518',color:'#F5C518',cursor:'pointer'}}>
                                    <ul class="pagination" >
                                        {
                                            pagesarr.map((page)=>(
                                                <li class="page-item" ><a style={{background:'black',color:'#F5C518',cursor:'pointer'}} class="page-link" onClick={()=>this.handlePageChange(page)}>{page}</a></li>
                                            ))
                                        }
                                    </ul>
                                </nav>
